...
class ControllerConstants {
    ...
    struct CommonURL {
        ...
        struct Debug {
            static let baseURL = "http://192.168.100.125:8080/v1"
        }
    ...
    struct Errors {
        ...
        static let passwordErrorSignUp = """
        Password should be 6 characters long with \
        one uppercase, lowercase and a number
        """
